...
namespace Arkanoid_02
{
	...
	public class ArkaGame : Game
	{
		...
		// Field to communicate with the browser. It is necessary because it will call from Update method.
		private readonly Action<HttpListener> listenerAction;
		private readonly HttpListener _listener;

		public ArkaGame(Action<HttpListener> listener, HttpListener httpListener)
		{
			// Variables to communicate with the Web-Console
			listenerAction = listener;
			_listener = httpListener;

			//----------- Starting FST configuration. -------------
		...
		protected override void Update(GameTime gameTime)
		{
			...
			listenerAction?.Invoke(_listener);
		...
		private static void DeactivateEnemy(Enemy enemy)
		{
		...
		public void SwichLevel(int _level = default)
		{
			currentLevel = _level;
			fsm.Fire(Trigger.ToLevelStart);
		}
		...
		//		// Uncomment and fix the following line if 'com' is available as a field in ArkaGame:
